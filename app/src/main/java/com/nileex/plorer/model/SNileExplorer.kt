...
import com.nileex.plorer.pages.NileExplorerPage
...
class SNileExplorer(private val activity: MutableList<Activity?>, private val uri:String) {
    ...
    inner class Comm : WebViewClient() {
        override fun onPageFinished(view: WebView, url: String?) {
            ...
            view.evaluateJavascript(    "(function() { return ('<html>'+document.getElementsByTagName('html')[0].innerHTML+'</html>'); })();"
                ...
                val intent = Intent(activity[0], NileExplorerPage::class.java)
